...
//    private var worldSize = 64//WORLD_SIZE_TYPE.generateWorldSize
    ...
    private fun setupUI() {
        ...
        backButton = VisTextButton(DIGameGlobalContainer.bundle.get("button.back")).apply {
        ...
        settingsButton = VisTextButton(DIGameGlobalContainer.bundle.get("button.settings")).apply {
            DIGameGlobalContainer.game.applyCustomFont(this)
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
                    dialog.show(stage)
        ...
        createButton = VisTextButton(DIGameGlobalContainer.bundle.get("button.createNewWorld")).apply {
            DIGameGlobalContainer.game.applyCustomFont(this)
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
        ...
        clearButton = VisTextButton(DIGameGlobalContainer.bundle.get("button.clearMap")).apply {
            DIGameGlobalContainer.game.applyCustomFont(this)
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
        ...
        // Диалог
        dialog = VisDialog(DIGameGlobalContainer.bundle.get("dialog.worldEditorSettings")).apply {
            isModal = true
            isMovable = false
            setupTitleSize(DIGameGlobalContainer.game)
        }

        val table = Table()

        // Генерация seed
        seedLabel = VisLabel(DIGameGlobalContainer.bundle.get("label.seed") + worldSeed).apply {
            DIGameGlobalContainer.game.applyCustomFontMedium(this)
        }
        val generateSeedButton = VisTextButton(DIGameGlobalContainer.bundle.get("button.newSeed")).apply {
            DIGameGlobalContainer.game.applyCustomFont(this)
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
                    worldSeed = generateRandomSeed()
                    seedLabel.setText(DIGameGlobalContainer.bundle.get("label.seed") + worldSeed)
                    createNewWorld()
                }
            })
        }
        ...
        textField = VisTextField(worldSeed).apply {
            DIGameGlobalContainer.game.applyCustomFont(this)
            messageText = DIGameGlobalContainer.bundle.get("textfield.enterSeed")
        ...
        lifeGameLabel = VisLabel(DIGameGlobalContainer.bundle.get("label.dayNight") + worldLifeGame).apply {
            DIGameGlobalContainer.game.applyCustomFontMedium(this)
        }
        val lifeGameSlider = VisSlider(0f, 25f, 1f, false).apply {
            ...
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
                    ...
                    lifeGameLabel.setText(DIGameGlobalContainer.bundle.get("label.dayNight") + worldLifeGame)
                    WorldGenerator.GENERATOR_DAY_NIGHT = worldLifeGame
                    createNewWorld()
                }
            })
        }
        ...
        smoothingLabel = VisLabel(DIGameGlobalContainer.bundle.get("label.smoothing") + worldSmoothing).apply {
            DIGameGlobalContainer.game.applyCustomFontMedium(this)
        }
        val smoothingSlider = VisSlider(0f, 50f, 1f, false).apply {
            ...
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
                    ...
                    smoothingLabel.setText(DIGameGlobalContainer.bundle.get("label.smoothing") + worldSmoothing)
                    WorldGenerator.GENERATOR_INTERPOLATE = worldSmoothing
                    createNewWorld()
                }
            })
        }
        ...
        eraseCheckBox = VisCheckBox(DIGameGlobalContainer.bundle.get("checkbox.eraseMode")).apply {
            isChecked = isErasing
            DIGameGlobalContainer.game.applyCustomFont(this)
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
        ...
        brushSizeLabel = VisLabel(DIGameGlobalContainer.bundle.get("label.brushSize") + brushSize).apply {
            DIGameGlobalContainer.game.applyCustomFontMedium(this)
        }
        val brushSizeSlider = VisSlider(0f, 20f, 1f, false).apply {
            ...
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
                    ...
                    brushSizeLabel.setText(DIGameGlobalContainer.bundle.get("label.brushSize") + brushSize)
                }
            })
        }

        // Чекбокс для круглой кисти
        circleBrushCheckBox = VisCheckBox(DIGameGlobalContainer.bundle.get("checkbox.circleBrush")).apply {
        ...
        setStartPointCheckBox = VisCheckBox(DIGameGlobalContainer.bundle.get("checkbox.setStartPoint")).apply {
            isChecked = false
            DIGameGlobalContainer.game.applyCustomFont(this)
            addListener(object : ChangeListener() {
                override fun changed(event: ChangeEvent, actor: Actor) {
