...
class NeuralLinkManager(
    ...
    fun transportNeuralSignal(
        ...
        val linkCellAIsDead = !isAlive[linkCellA] || getGeneration(linkCellA) != neuralLinkEntity.linksGeneration1[linkIndex]
        val linkCellBIsDead = !isAlive[linkCellB] || getGeneration(linkCellB) != neuralLinkEntity.linksGeneration2[linkIndex]
